...
\begin{columns}[c,onlytextwidth]\column{.21\textwidth}\centering\input{slike/tikz/s031_cmos_invertor.tex}\column{.77\textwidth}Uslov da tranzistor N radi u omskoj oblasti
\[V_{DS,N} \le \frac{(V_{GS,N}-V_{Tn})}{1+\frac{(V_{GS,N}-V_{Tn})}{L_nE_{Cn}}}\qquad V_O \le \frac{(V_I-V_{Tn})}{1+\frac{(V_I-V_{Tn})}{L_nE_{Cn}}}\]
