...
\inputminted[fontsize=\small, frame=single]{vhdl}{code/Zadatak_4/zadatak_4.vhd}

\newpage
\noindent
Testbench koji simulira prelazak $ABCD = 1111$ \textrightarrow~$ABCD = 1110$.
\inputminted[fontsize=\small, frame=single]{vhdl}{code/Zadatak_4/tb_zadatak_4.vhd}
