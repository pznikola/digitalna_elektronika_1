...
\begin{document}
\begin{tikzpicture}[thick,>=Latex,b/.style={draw,minimum width=2.7cm,minimum height=1.35cm,align=center}]
...
\draw[->](c.east)--(5,-1.4)--(mux.south)node[midway,right]{$G$};\draw[->](c.south)--(0,-2.7)--(9,-2.7)--(mask.south)node[midway,right]{$\bar E$};
\end{tikzpicture}
\end{document}
