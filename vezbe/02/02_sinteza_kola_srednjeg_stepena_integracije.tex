...
\noindent
VHDL kod koji implementira jedna\v{c}inu~\eqref{eq:zad2-d1}.\\
\textbf{Napomena:} Kašnjenja dodata u kod se koriste samo za simulacije!
...
na nivou logičke nule, dok su ostali ulazi (osim EN\textsubscript{1} u EN\textsubscript{2}) aktivni na nivou logičke jedinice.
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.62\linewidth]{Zadatak_3/Zadatak_3a}% adjust path if needed
